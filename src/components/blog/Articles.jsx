...
const ArticleCard = ({ author, date, readTime, title, description, url }) => {
  ...
  return (
    <article
      ...
      className="flex flex-col p-6 bg-white rounded-lg bg-secondary  dark:bg-darksecondary dark:border-gray-700 hover:scale-105 transition duration-500 cursor-pointer object-cover"
    >
