...
const ContactSection = () => {
  return (
        <section class="bg-background px-4 lg:px-36 text-gray-400 dark:bg-darkbackground body-font relative font-roboto ">
            <h2 class="mb-4 text-4xl text-center tracking-tight font-extrabold font-roboto text-primary dark:text-darkprimary">Contact Us</h2>
            <p class="mb-8 lg:mb-16 font-light font-roboto text-center text-body dark:text-darktext dark:opacity-90 sm:text-xl">Seeking information about our collaboration opportunities? Looking to Volunteer with Us? Talk to us.</p>
            <div class="container px-5 py-5 mx-auto flex sm:flex-nowrap flex-wrap">
                ...
                <div class="bg-secondary dark:bg-darkbackground relative flex flex-wrap py-6 rounded shadow-md">
                    ...
                    <h2 class="title-font font-semibold font-roboto text-gray-800 dark:text-darktext tracking-widest text-xs">ADDRESS</h2>
                    <p class="text-navytext dark:text-darktext dark:opacity-80 mt-1">VIT, Vellore Campus, Tiruvalam Rd, Katpadi, Vellore, Tamil Nadu 632014, India</p>
                    </div>
                    <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
                    <h2 class="title-font font-semibold font-roboto text-gray-800 dark:text-darktext tracking-widest text-xs">EMAIL</h2>
                    <a href="/"class="text-primary dark:text-primary leading-relaxed">bif@vit.ac.in</a>
                    <h2 class="title-font font-semibold font-roboto text-gray-800 dark:text-darktext tracking-widest text-xs mt-4">PHONE</h2>
                    <p class="text-primary dark:text-primary leading-relaxed"> <a href="/">+91 97521 50070</a> </p>
                    </div>
                </div>
                </div>
                ...
                <form action="#" class="space-y-8">
                     <div>
                         <label for="email" class="block mb-2 text-sm font-medium font-roboto text-body dark:text-darktext">Your email</label>
                     ...
                     <div>
                         <label for="subject" class="block mb-2 text-sm font-medium font-roboto text-body dark:text-darktext">Subject</label>
                     ...
                     <div>
                        <label for="countries" class="block mb-2 text-sm font-medium font-roboto text-body dark:text-darktext">Topic</label>
                            <select id="countries" class="shadow-sm bg-secondary dark:bg-darksecondary text-body text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-3  dark:placeholder-darktext dark:placeholder-opacity-50 dark:text-darktext dark:focus:ring-darkhighlight dark:focus:border-darkhighlight dark:shadow-sm-light">
                     ...
                     <div class="sm:col-span-2">
                         <label for="message" class="block mb-2 text-sm font-medium font-roboto text-body dark:text-darktext">Your message</label>
                    ...
                    <div class="flex items-center">
                         ...
                         <label for="link-checkbox" class="ml-2 text-sm font-medium font-roboto text-body dark:text-darktext">By submitting this form, you confirm that you have read and agree to our <a class="text-primary dark:text-darkprimary hover:underline" href='/'>Terms & Conditions</a>.</label>
                     </div>
