...
const Reviews = () => {
  ...
  function getRandomJob() {
    ...
    const indianSchoolAbbreviations = [
      "DPS",
      "KV",
      "DAV",
      "JNV",
    ...
    const randomAbbreviation =
      indianSchoolAbbreviations[
        Math.floor(Math.random() * indianSchoolAbbreviations.length)
      ];
  ...
  return (
    <section
      id="testimonies"
      class="py-20 bg-background dark:bg-darkbackground"
    >
      <div class="max-w-6xl mx-8 md:mx-10 lg:mx-20 xl:mx-auto">
        <div class="transition duration-500 ease-in-out transform scale-100 translate-x-0 translate-y-0 opacity-100">
          <div class="mb-12 space-y-5 md:mb-16 md:text-center">
            <h1 class="mb-8 text-3xl font-bold font-roboto text-primary dark:text-darkprimary sm:text-4xl">
              Inspiring Stories 
            </h1>
            <p class="text-body dark:text-darktext mb-8 font-light font-roboto dark:opacity-90 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo
              maiores itaque in dolore vitae architecto ipsa minus, sequi,
              voluptates ipsam a inventore? Praesentium enim at recusandae, non
              cum earum placeat!
            </p>
          </div>
        </div>
          ...
          <ul class="space-y-8">
            <li class="text-sm leading-6">
              <div class="relative group">
                <div class="absolute rounded-lg opacity-25 -inset-1 blur duration-400 group-hover:opacity-100 group-hover:duration-200"></div>
                <a href="/" class="cursor-pointer">
                  <div class="relative p-6 space-y-6 leading-none hover:scale-110 transition duration-500 cursor-pointer object-cover rounded-lg bg-secondary dark:bg-darksecondary">
                    <div class="flex items-center space-x-4">
                      <img
                        ...
                        alt="{ getRandomIndianName() }"
                      />
                      <div>
                        <h3 class="text-navytext dark:text-darktext text-lg font-semibold font-roboto text-white">
                          {getRandomIndianName()}
                        </h3>
                        <p class="text-navytext dark:text-darktext dark:opacity-75 text-md ">
                          {getRandomJob()}
                        </p>
                      </div>
                    </div>
                    <p class="text-navytext dark:text-darktext leading-normal dark:opacity-90 text-gray-300 text-md">
            ...
            <li class="text-sm leading-6">
              <div class="relative group">
                <div class="absolute rounded-lg opacity-25 -inset-1  transition blur duration-400 group-hover:opacity-100 group-hover:duration-200"></div>
